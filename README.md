...
This application brings you a basic knowledge about creating a new component, inserting them to a page and creating a new public parameter to modify one component behavior at page in importing time.
